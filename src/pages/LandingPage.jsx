      ...
      <header style={{ 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <a href="/login" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontWeight: '500', fontSize: '0.95rem' }}>Entrar</a>
            <button 
      ...
      <section style={{ 
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ 
            ...
            <span style={{ color: '#a855f7', fontSize: '0.85rem', fontWeight: '600' }}>🚀 A plataforma definitivo para seu negócio</span>
          </div>
